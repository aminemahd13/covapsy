...
| `/wrong_direction` | `std_msgs/Bool` | sim bridge or border pipeline | `mode_controller_node` |
| `/wrong_direction_confidence` | `std_msgs/Float32` | sim bridge or border pipeline | `mode_controller_node` |
